  ...
  return (
    <div>
      <h2 id="game-heading" data-cy="GameHeading">
        <Translate contentKey="wemeetadminApp.game.home.title">Games</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="wemeetadminApp.game.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/game/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="wemeetadminApp.game.home.createLabel">Create new Game</Translate>
          </Link>
        </div>
      </h2>
        ...
        {gameList && gameList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="wemeetadminApp.game.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/game/${game.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/game/${game.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="wemeetadminApp.game.home.notFound">No Games found</Translate>
            </div>
          )
        )}
      </div>
      {totalItems ? (
        <div className={gameList && gameList.length > 0 ? '' : 'd-none'}>
