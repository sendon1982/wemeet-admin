...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IGame, thunkAPI) => {
    const result = await axios.post<IGame>(apiUrl, cleanEntity(entity));
...
export const updateEntity = createAsyncThunk(
  'game/update_entity',
  async (entity: IGame, thunkAPI) => {
    const result = await axios.put<IGame>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IGame, thunkAPI) => {
    const result = await axios.patch<IGame>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    const result = await axios.delete<IGame>(requestUrl);
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
