...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOARDGAME_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOARDGAME actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOARDGAME actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_BOARDGAME actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_BOARDGAME actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_BOARDGAME actions', async () => {
      const arg = 42666;
