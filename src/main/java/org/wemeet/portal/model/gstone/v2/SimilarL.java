...
public class SimilarL {
    ...
    private SalesMode__3 salesMode;
    ...
    private FirstPicture__2 firstPicture;

    @JsonProperty("status_content")
    private StatusContent__2 statusContent;
    ...
    @JsonProperty("sales_mode")
    public SalesMode__3 getSalesMode() {
        return salesMode;
    }

    @JsonProperty("sales_mode")
    public void setSalesMode(SalesMode__3 salesMode) {
    ...
    @JsonProperty("first_picture")
    public FirstPicture__2 getFirstPicture() {
        return firstPicture;
    }

    @JsonProperty("first_picture")
    public void setFirstPicture(FirstPicture__2 firstPicture) {
        this.firstPicture = firstPicture;
    }

    @JsonProperty("status_content")
    public StatusContent__2 getStatusContent() {
        return statusContent;
    }

    @JsonProperty("status_content")
    public void setStatusContent(StatusContent__2 statusContent) {
